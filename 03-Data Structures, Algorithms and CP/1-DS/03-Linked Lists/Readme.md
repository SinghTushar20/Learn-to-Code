...
- Finding Cycles/Loop/Ring in linked list. Check whether the given linked list is NULL-terminated or not. If there is a cycle find the start node of the loop and the length of the loop.
