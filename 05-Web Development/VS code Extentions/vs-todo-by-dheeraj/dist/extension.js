...
class HelloWorldPanel {
    ...
    static createOrShow(extensionUri) {
        ...
        const panel = vscode.window.createWebviewPanel(HelloWorldPanel.viewType, "Hello World Pannel", column || vscode.ViewColumn.One, {
...
HelloWorldPanel.viewType = "helloWorld";
...
class SidebarProvider {
    ...
    _getHtmlForWebview(webview) {
        ...
        <script nonce="${nonce}">
          const tsvscode =  acqireVsCodeApi();
        </script>
			</head>
      <body>
...
function activate(context) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand("vs-todo-by-dheeraj.helloWorld", () => {
        helloWorldPanel_1.HelloWorldPanel.createOrShow(context.extensionUri);
    }));
    context.subscriptions.push(vscode.commands.registerCommand("vs-todo-by-dheeraj.refresh", async () => {
    ...
    context.subscriptions.push(vscode.commands.registerCommand("vs-todo-by-dheeraj.helloWorld2", async () => {
        const reply = await vscode.window.showInformationMessage("New Hello world from us", "Hallo", "Konnichiwa");
        reply !== undefined
            ? reply === "Konnichiwa"
                ? vscode.window.showInformationMessage("Japanese huh...")
                : vscode.window.showInformationMessage("Wow German... I am trying to learn it as well... Mind helping me.. ;p")
