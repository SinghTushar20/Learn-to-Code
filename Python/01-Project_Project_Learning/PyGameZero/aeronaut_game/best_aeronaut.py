...
def draw(): #autocalled to reflect the latest states of the actors
    ...
    if game_running:
        ...
        screen.draw.text('Score: ' + str(score), topleft=(500, 50),  color='yellow', gcolor='green', fontsize=48, owidth=0.5, ocolor='black')
        ...
        button_replay.draw()
        if show_high_score:
            screen.draw.text('New Record: ' + str(score), midtop=(WIDTH//2, 50),  color='yellow', gcolor='green', fontsize=48, owidth=0.5, ocolor='black')
