var app = (function () {
    ...
    /* webviews\components\Sidebar.svelte generated by Svelte v3.43.0 */
    ...
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(30:4) {#each tasks as task}",
    		ctx
    	});
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const submit_handler = e => {
    		e.preventDefault();
    		$$invalidate(0, tasks = [{ title: text, status: false }, ...tasks]);
    		$$invalidate(1, text = "");
    	};

    	const click_handler = (task, each_value, task_index) => {
